...
//------------------------------------------------------------------------------
static uint8_t w_adrs;
static uint8_t r_adrs;
...
//------------------------------------------------------------------------------
uint16_t ds3231_set_alarm(ds3231_alrm_t alarm, bool one_r_two)
{
    uint8_t data[] = {0,0,0,0,0};
    uint8_t data_length = 0;
    uint8_t max_hour = 24;
...
//------------------------------------------------------------------------------
uint16_t ds3231_set_cntl_stat_reg(ds3231_cntl_stat_t data)
{
...
//------------------------------------------------------------------------------
uint16_t ds3231_get_time(ds3231_time_t* time)
{
    uint16_t rtn_val = 1;
    uint8_t data[3];
...
//------------------------------------------------------------------------------
uint16_t ds3231_get_calendar(ds3231_calendar_t* calendar)
{
    uint16_t rtn_val = 1;
    uint8_t data[4];
...
//------------------------------------------------------------------------------
uint16_t ds3231_get_alarm(ds3231_alrm_t* alarm, bool one_r_two)
{
    uint16_t rtn_val = 1;
    uint8_t data[4];
...
//------------------------------------------------------------------------------
uint16_t ds3231_get_cntl_stat_reg(ds3231_cntl_stat_t* data)
{
    uint16_t rtn_val = 1;
...
//------------------------------------------------------------------------------
uint16_t ds3231_get_temperature(void)
{
    uint16_t rtn_val = 1;
    uint8_t data[2];
